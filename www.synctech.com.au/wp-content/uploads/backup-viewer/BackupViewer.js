...
function showMedia(messageIndex, partIndex) {
    ...
    mediaDiv.innerHTML = "<img src= '/wp-content/uploads/backup-viewer/loading.gif'/>";
...
function printConversation() {
    ...
    printWindow.document.write('<link rel="stylesheet" href="/wp-content/uploads/backup-viewer/StyleSheet.css" type="text/css" />');
...
function createWorker() {
    ...
    worker = new Worker("/wp-content/uploads/backup-viewer/KXmlParser.js?v=2024-02-22");
            ...
            switch (e.data.name) {
                ...
                case "FINISHED_CONVERSATIONS": {
                    ...
                    data.push("<table class='backupViewerTable' id='backupViewerContacts'><tr><th class='backupViewerTH'>Select a conversation " +
                        "<div id='hideConversationsArrow' onclick='collapseConversations();'><img src='/wp-content/uploads/backup-viewer/arrow-left.png' width='20' /></div>" +
    ...
    worker.onerror = function (e) {
        ...
        var errorDetails = "There was an error processing the file. Please try again by reloading the page. If the issue persists, <a href='https://synctech.com.au/report-issues/' target='_blank' onclick='document.getElementById(\"viewer-error-contact-form\").submit(); return false;'>Report this problem</a>.<br/><br/>" +
